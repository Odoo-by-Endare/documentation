...
Both charts of accounts SKR03 and SKR04 are supported in Odoo. When you create a new Odoo Online
...
In Odoo, it is possible to export accounting entries and the corresponding reports. To use this
feature, one of the German :ref:`fiscal localization packages <fiscal_localizations/accounting>`
needs to be installed on your database.
...
.. note::
   To fully understand the implications of GoBD, it is best to read the `official GoBD text
   ...
   The document is long but accessible even to non-experts.
